...
<nav class="navbar">
  ...
  <div class="nav-links">
    <a href="/new_common/map.jsp" class="nav-item">
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        <polygon points="3 11 22 2 13 21 11 13 3 11"/>
      </svg>
      <span>Map View</span>
    </a>
    <a href="/new_common/dashboard.jsp" class="nav-item">
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <a href="/new_common/messages" class="nav-item">
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
  ...
  <div class="nav-right">
    ...
    <div class="profile-info">
      ...
      <!-- ✅ NEW: Change Level Button -->
      <button class="edit-level-btn" id="openLevelModal" style="background: none; border: none; color: #9333ea; font-size: 11px; cursor: pointer; margin-top: 4px;">
        ✏️ Change Level
      </button>
    </div>
...
<main class="main">
  ...
  <section class="stats">
    <div class="stat-card">
      ...
      <div>
        <div class="stat-value" id="nearbyCount">-</div>
    ...
    <div class="stat-card">
      ...
      <div>
        <div class="stat-value" id="userLevelDisplay"><%= userLevel %></div>
  ...
  <section class="matches-section">
    ...
    <div class="filter-panel" id="filterPanel">
      ...
      <div class="filter-group">
        ...
        <div class="filter-chips" id="sportsFilterChips">
          <button class="chip active" data-filter="sports" data-value="all">All</button>
          <!-- Sports will be dynamically added here from JavaScript -->
        </div>
      </div>
    ...
    <!-- MATCH CARDS loaded by script.js -->
  ...
  <div class="modal" role="dialog" aria-modal="true" aria-labelledby="modalTitle">
    ...
    <form id="eventForm" method="post" action="addEvent">
      <div class="modal-body">
        ...
        <!-- HIDDEN: filled automatically by geolocation -->
...
<!-- ✅ NEW: CHANGE LEVEL MODAL -->
<div class="modal-overlay" id="levelModalOverlay">
  <div class="modal" role="dialog" aria-modal="true" aria-labelledby="levelModalTitle">
    <div class="modal-header">
      <h3 id="levelModalTitle">
      ...
      <button class="modal-close" id="closeLevelModal" aria-label="Close">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <div class="modal-body">
      <div class="form-group">
        <label for="userLevelSelect">Select Your Skill Level</label>
        <select id="userLevelSelect" class="level-select">
      ...
      <div class="form-group">
        ...
        <div class="current-level-display" id="currentLevelDisplay" style="padding: 10px; background: #f0f0f5; border-radius: 8px; font-weight: bold;"></div>
      </div>
    </div>
    <div class="modal-footer">
      <button type="button" class="btn-cancel" id="cancelLevelModal">Cancel</button>
      <button type="button" class="btn-save" id="saveLevelBtn">Save Changes</button>
    </div>
  </div>
</div>
